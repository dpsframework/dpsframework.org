...
- Cargar a continuación un archivo de propuesta complejo, e.g. **grid4x4-pa.clp**.
...
- Y observar a continuación el volcado en el Log del sistema generado por JADE, en función de las actuaciones que ha llevado a cabo el agente **Analizador200** para resolver y responder a las cuestiones plateadas.

...
1. Compilardor y entorno de desarrollo Java: plataforma Java y  versiones de análisis temprano OpenJDK, accesibles en **JAVA/openJDK-17...-19**[^ORACLE] y superiores.[^TILAB]
...
1. Herramientas de construcción de Sistemas Expertos[^yeoh12], utilizadas por los Agentes:
- CLIPS[^CLIPS].
- JESS[^JESS].
...
1. Distributed problem solving[^yeoh12]. Yeoh, W., and Yokoo, M. (2012). Distributed problem solving. AI Magazine, 33(3), 53-53.
...
[^yeoh12]: **Distributed problem solving**: Yeoh, W., and Yokoo, M. (2012). Distributed problem solving. AI Magazine, 33(3), 53-53. Available at: <https://ojs.aaai.org/index.php/aimagazine/article/download/2429/2321>

...
> **{{ site.data.i18n[page.lang].abstract }}:**  Los agentes autónomos e inteligentes son una subárea de la Inteligencia Artificial simbólica donde esos agentes deciden, ya sea de forma reactiva o proactiva, razonando sobre un curso de acción y sobre la información disponible del entorno (incluido el entorno, el propio agente y los otros agentes). Abarca multitud de técnicas; como protocolos de negociación; simulación de agentes; argumentación multiagente; planificación multiagente y muchas otras. En este artículo, nos enfocamos en la programación de agentes y proporcionamos una revisión sistemática de la literatura sobre programación basada en agentes para sistemas multiagente. En particular, analizamos tanto los lenguajes de programación de agentes veteranos (aún mantenidos) como los novedosos, sus extensiones, el trabajo de comparación de algunos de estos lenguajes y las aplicaciones encontradas en la literatura que hacen uso de la programación de agentes.

...
2. Interacción externa (agente) para intercambiar:
    ...
    a. Contenido de la interacción que incluye información y tareas;
...
El foro de estándares de agentes FIPA [Poslad y Charlton 2001] se centra en la especificación de protocolos para la interacción externa y los servicios de plataforma en lugar del "comportamiento" del agente interno, ya que este último no es fácilmente accesible y observable, en contraste con la interacción de agentes externos. Además, los algoritmos adecuados para especificar los "comportamientos" internos de diferentes tipos de agentes son difíciles de estandarizar, ya que a menudo son una combinación de ser específicos de un problema, ser específicos de una aplicación y la necesidad de que las organizaciones los mantengan privados en lugar de hacerlos públicos.
...
_**Fig. 2. La interacción MAS se especifica en términos de una lista de campos de encabezado para definir los protocolos AIPS particulares utilizados y otros campos como el remitente, el receptor, etc.**_
...
El Lenguaje Semántico (SL) se utiliza para definir la semántica de las FIPA CAs como una lógica de actitudes y acciones mentales, formalizada en un lenguaje modal de primer orden con identidad; consulte la Especificación de la biblioteca de actos comunicativos de FIPA [FIPA 2002] para obtener detalles de esta lógica. Para que el remitente planee o pretenda una CA, se deben especificar tanto las condiciones previas (las razones por las que se selecciona el acto) como las condiciones (posteriores) que deben cumplirse cuando se completa el acto.
...
_**Fig. 4. Sintaxis para intercambiar mensajes tipo CA.**_
...
###  3.1.1. Uso de BDI Semantics para CA.
...
_**Tabla I. Tipos de Actos Comunicativos FIPA (ACs)**_

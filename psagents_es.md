...
- Cite list: [^TILAB], [^SHOHAM],[^FIPA],[^HSQL],[^WOOL],[^PI],[^ORACLE],[^PROTEGEE],[^GITREPO],[^CLIPS],[^JESS],[^PROLOG],[^UNILEON],[^BEANSHEL],[^RSYNTAX],[^UNILEONDEPT],[^RUSSELL],[^YELLOW],[^CPLUS],[^RAZON]
...
[^ORACLE]: **ORACLE Java**. Java(TM) Platform Standard and JDK, versions: <http://www.oracle.com/technetwork/java/javase/downloads/index.html> (2017).
